...
4. PROHIBITED USE
• Unauthorized copying, redistribution, resale, sublicensing, or public sharing of the application or its outputs  
• Reverse engineering, decompilation, disassembly, or replication of application logic, workflows, analytics, or report formats  
• Use of RP Spray Analytics for competitive, commercial, or third-party purposes  
• Incorporation of RP Spray Analytics into another product, service, or platform  

5. DATA OWNERSHIP
Teams retain ownership of their raw game data. All analytics, visualizations, reports, workflows, and output formats generated by RP Spray Analytics remain the intellectual property of RP Spray Analytics.

6. ACCESS CONTROL & TERMINATION
RP Spray Analytics reserves the right to suspend or revoke access immediately for license violations, misuse, or unauthorized sharing without refund.
...
agree_terms = st.checkbox("I have read and agree to the Terms of Use")

if st.button("Continue"):
    if not agree_terms:
        st.warning("You must agree to the Terms of Use to continue.")
    else:
